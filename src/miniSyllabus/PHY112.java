 ...
 * @author Israt Jahan
 */
public class PHY112 extends javax.swing.JFrame {

    /**
     * Creates new form PHY112
     */
    public PHY112() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        eng111.setText("                   PHY 112: Physics I Lab");
        ...
        jTextArea3.setText(" This course explains the very fundamental requirements for scientific e.g. use of graph papers (Linear-linear, Linear-log and Log-log), error calculations and use of different electronic equipment's like Multi-meter, Oscilloscope and Signal Generator etc.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PHY112.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
