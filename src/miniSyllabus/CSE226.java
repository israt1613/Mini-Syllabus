 ...
 * @author Israt Jahan
 */
public class CSE226 extends javax.swing.JFrame {

    /**
     * Creates new form CSE226
     */
    public CSE226() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        eng111.setText("CSE 226: Algorithm lab");
        eng111.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(eng111, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, 170, 20));
        ...
        jTextArea3.setText("  Labratory works based on CSE 225.");
        ...
        getContentPane().add(firstSem, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, 180, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE226.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
