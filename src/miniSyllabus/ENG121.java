 ...
 * @author Israt Jahan
 */
public class ENG121 extends javax.swing.JFrame {

    /**
     * Creates new form ENG121
     */
    public ENG121() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Grammer.setText("Spoken English:");
        getContentPane().add(Grammer, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 236, 120, 20));

        Vocabulary.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        Vocabulary.setText("Professional communication:");
        getContentPane().add(Vocabulary, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 210, 20));
        ...
        Spoken.setText("Technical Writing:");
        getContentPane().add(Spoken, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 128, 130, 20));
        ...
        eng111.setText("ENG 121: English Foundation II");
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 340, 550, 360));
        ...
        jTextArea3.setText("                                 Paragraph & composition writing on scientific & other\nthemes, report writing, research paper writing, library references.\n\n                                                   Business letter, job application, memos,\nquotations, tender notice.\n\n                             Introduction to phonetic symbols, dialogue, responding to\nparticular situations, extempore speech.");
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(28, 130, 550, 180));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ENG121.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
