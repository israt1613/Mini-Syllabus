...
public class CGPA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("CGPA calculation:");
        getContentPane().add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, -1, -1));

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniSyllabus/cgpa_pic.png"))); // NOI18N
        getContentPane().add(pic, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 530, 190));
        ...
        jTextArea1.setText("Student's performance will be evaluated on the basis of Grade Point Average (GPA) semester wise and Cumulative Grade Point Average (CGPA) of total completed courses.\n\nThe CGPA will be computed in the following manner:");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 540, 100));
