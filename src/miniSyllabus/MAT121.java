 ...
 * @author Israt Jahan
 */
public class MAT121 extends javax.swing.JFrame {

    /**
     * Creates new form MAT121
     */
    public MAT121() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Spoken.setText("Co-ordinate Geometry: ");
        getContentPane().add(Spoken, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 128, 170, 20));
        ...
        getContentPane().add(BooksRec, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 160, 20));
        ...
        eng111.setText("MAT 121: Coordinate Geometry & Vector Analysis");
        eng111.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(eng111, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 350, 20));

        Reading.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        Reading.setText("Vector Analysis:");
        getContentPane().add(Reading, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 110, 20));
        ...
        jTextArea4.setText("1. Rahman,           : A text book on of coordinate geometry with vector analysis, \n    A.F.M. Abdur ,     S. Bhattacharjee, Chitagang\n   Bhattacharjee,\n   P.K.\n\n2. M. R. Spiegel,    :  Vector Analysis and An Introduction to Tensor Analysis,                    S. Lipschutz,         McGraw-Hill\n    D.Spellman\n");
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 360, 550, 170));
        ...
        jTextArea3.setText("                                          Co-ordinates; Polar co-ordinates; The straight line;\nChange of axes; Pair of straight lines; circles; system of circles; Parabola;\nEllipse; Hyperbola.\n\n                             Vector algebra; scalar and vector product; Scalar and\nvector fields; Application of vectors in geometry; Calculus of vector valued\nfunction; Differentiation of vectors; Gradient; Divergence and curl of a\nvectors; Gradient, Divergence and Curl of a vector and their physical\nsignificance; Directional derivatives; vector Integration; Green’s theorem,\nStocke’s theorem, Divergence theorem with example.");
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(28, 130, 550, 200));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MAT121.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
