 ...
 * @author Israt Jahan
 */
public class CSE133 extends javax.swing.JFrame {

    /**
     * Creates new form CSE133
     */
    public CSE133() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        eng111.setText("CSE 133: Object Oriented Programming");
        eng111.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(eng111, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 290, 20));
        ...
        jTextArea4.setText("1. H. Schidt                         : C++: A Beginner's Guide, McGraw Hill\n\n2.. H. Schidt                        : C++: The Complete Reference, McGraw Hill\n\n3. N. Barkakati                    : Object Oriented Programming with C++, Prentice Hall                                                India\n4. B. Stroustrap                  : The C++ Pr");
        ...
        jTextArea3.setText("Introduction: Object oriented programming and procedural oriented programming, encapsulation, inheritance, polymorphism, data abstraction, data binding, static and dynamic binding, message passing.\n\nC++ as an object oriented language: Declaration and constants, expression and statements, data types, operator, Functions.\n\nClasses: structure of classless. public, private and protected members, array of object, argumented member function, and non-augmented objects, nested member class and their object, pointer objects and pointer members, object a\nargument of function, static class member and static class. Friend function, friend class.\n\nInheritance: mode of inheritance, classifications of inheritance, virtual\ninheritance.Array of objects of derived class.\nConstructor and destructors: Default constructor, argumented constructor,\ncopy constructor, dynamic constructor, constructor function for derived class\nand their order of execution, destructor.\n\nOperator and function overloading: unary and binary operator overloading,\nrun-time and compile time polymorphism, object pointer and pointer to an\nobject, virtual function, dynamic binding.\nC++ data file: C++ file stream classes, input and output file, mode of files,\nfile pointer, random file accessing,\nTemplate and Exception handling: function template and class template,\nException Handling");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE133.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
