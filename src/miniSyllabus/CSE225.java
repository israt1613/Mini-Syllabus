 ...
 * @author Israt Jahan
 */
public class CSE225 extends javax.swing.JFrame {

    /**
     * Creates new form CSE225
     */
    public CSE225() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        eng111.setText("CSE 225 : Algorithms");
        ...
        jTextArea4.setText("1. Thomas H. Kormen, Charles    : Introduction to Algorithms, The MIT Press\n  E. Leiserson, Ronald L.\n  Rivest, Clifford Stein\n\n2. D. E. Knuth : The Art of Computer Programming, Vol. 1, 2, 3, Addison-Wesley.\n\n3. Ellis Horowitz, Sartaj Sahni     : Fundamentals of Computer Algorithms, Galgotia \nand Sanguthevar Rajasekaran      Publications\n");
        ...
        jTextArea3.setText("Basics of Algorithm: Algorithms as a technology, Analyzing algorithms,\nDesigning algorithms, Time and space analysis of algorithms, Average, best\nand worst case analysis, different notations.\n\nSorting: Insertion sort, Heap sort, Quicksort, Counting sort, Radix sort,\nBucket sort.\n\nDynamic programming: Assembly-line scheduling, Matrix-chain\nmultiplication, Longest common subsequence, Optimal binary search trees.\nGreedy method: An activity-selection problem, Elements of the greedy\nstrategy, Huffman codes.\n\nGraph algorithms: Depth-first search, Breadth-first search, Topological sort,\nMinimum spanning tree, Kruskal’s and Prim’s algorithm, Bellman-Ford\nalgorithm, Dijkstra’s algorithm, Floyd-Warshall algorithm, Johnson’s\nalgorithm for sparse graphs, Ford-Fulkerson method.\n\nComputational Geometry: Line-segment properties, Determining whether\nany pair of segments intersects, Finding the convex hull, Finding the closest\npair of points.\n\nBacktracking: 8 queen’s problem, Sum of subsets, Graph coloring problem,\nand Hamilton cycles.\n\nBranch and bound: Lest cost search, 15-puzzle problem, Knapsack problem,\nTraveling salesman problem.\n\nNP-Completeness: Polynomial time, Polynomial-time verification, NPcompleteness and reducibility, NP-complete problems. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE225.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
