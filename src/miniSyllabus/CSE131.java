 ...
 * @author Israt Jahan
 */
public class CSE131 extends javax.swing.JFrame {

    /**
     * Creates new form CSE131
     */
    public CSE131() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        eng111.setText("CSE 131: Discrete Mathematics");
        eng111.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(eng111, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 220, 20));
        ...
        getContentPane().add(BooksRec, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 570, 160, 20));
        ...
        jTextArea3.setText("Introduction: Logic and Proofs, Mathematical Inductions, Sets, Equivalence relations, Language and recursive definitions.\n\nCounting: Basic principles, sequences, Fibonacci, Eullerian, Bernoulli numbers, permutation, and Pascal’s triangle.\n\nRelation and ordering: Relations, properties of Binary relation in a set, composition of binary relation, relation matrix and graph of a relation, partial ordering, path in relation and di-graph.\n\nOrdered relation and structure: Partially ordered set, external element of P.O. set, Lattice, finite Boolean algebra, function on Boolean algebra, Boolean function as Boolean polynomial.\n\nGraph: Introduction to graph, graph terminology, representing graph and graph isomorphism, paths, reachability, connectivity, Euler and Hamilton path, shortest path problems, graph colouring, matrix representation of graph.\n\nTrees: Introduction of trees, application of trees, tree traversal, labeling trees, trees and sorting, spanning trees, minimal spanning tree, and undirected trees.\n\nAlgebraic structure: Algebraic system, general properties, some simple algebraic system, ring, semiring, module, semi-module, Homomorphism of semigroups and monoid, Grammars and languages, Formal definition of a language, Definition and examples, homomorphism, product and quotients of\ngroup.");
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 550, 480));
        ...
        jTextArea4.setText("1. Kenneth H. Rosen        : Discrete Mathematics and Its Applications,McGraw-Hill.\n\n2. J. P. Tremblay and        : Discrete Mathematics structures with applications to\n   R. Manohar                      Computer Science, Mc-Graw hill\n\n3. C.L. Liu                          : Elements of Discrete Mathematics, McGrawHill.\n\n4. Seymour                       : Theory and Problems of DiscreteMathematics,\nLipschutz                              Schaum's Outline Series,McGraw-Hill\n \n5. Bernard Kolman,          : Discrete Mathematical Structures, Prentice Hall\nRobert Busby,\nSharon C. Ross\n");
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 590, 550, 110));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE131.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
